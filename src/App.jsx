...
import { createAppStore, StoreProvider, ROLE_CONFIG, ROLE_KINDS } from './state';
import { ActorsView, AgentsView, CinematographersView, ComposersView, DirectorsView, EditorsView, ProducersView, WritersView } from './views';
...
export function App() {
    ...
    const handleGlobalFilterToggle = (event) => {
      ...
      <main class="layout">
        ...
        {hasSave && (<>
            <section class="panel">
              ...
              <div class="panel__controls" style="justify-content: flex-end;">
              ...
              <div class="tabs">
                {tabEntries.map((entry) => (<button key={entry.key} type="button" class={`tabs__button${activeTab === entry.key ? ' tabs__button--active' : ''}`} onClick={() => setActiveTab(entry.key)}>
